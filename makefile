...
PROJECT_NAME = src/score_snatcher
...
# --cov-branch: TrThis is template repository that can be used for starting other repositories.ack branch coverage, not just line coverage
pytest:
